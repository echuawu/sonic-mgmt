...
def cleanup_config(topology_obj, engine, ip_config_dict):
    ...
    topology_obj.players['dut']['cli'].general.execute_command_in_docker(docker='swss', command=del_routes_command)
...
def test_scale_static_route(cli_objects, engines, players, interfaces, static_route_configuration):
    """
