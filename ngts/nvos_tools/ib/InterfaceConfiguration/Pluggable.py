...
class Pluggable(ConfigurationBase):
    ...
    def __init__(self, port_obj):
        ...
        self.identifier = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_IDENTIFIER,
        ...
        self.cable_length = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_CABLE_LENGTH,
        ...
        self.vendor_name = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_VENDOR_NAME,
        ...
        self.vendor_pn = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_VENDOR_PN,
        ...
        self.vendor_rev = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_VENDOR_REV,
        ...
        self.vendor_sn = PluggableBase(port_obj=port_obj, label=IbInterfaceConsts.PLUGGABLE_VENDOR_SN,
