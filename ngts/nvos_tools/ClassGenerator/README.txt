# -------------- Yaml to Python Classes Converter ------------------

Please visit this WIKI page for example and more info:
https://wikinox.mellanox.com/display/SW/NVOS+Verification+-+How+to+create+relevant+classes+under+NGTS+environment
