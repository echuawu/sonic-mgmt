...
from ngts.nvos_tools.platform.Channel import Channel
...
class Transceiver(BaseComponent):
    ...
    def __init__(self, parent_obj):
        ...
        self._resource_path = '/transceiver/{transceiver_id}'
        self.parent_obj = parent_obj

    def get_resource_path(self):
        self_path = self._resource_path.format(transceiver_id=self.transceiver_id).rstrip("/")
