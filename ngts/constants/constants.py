...
class AppExtensionInstallationConstants:
    ...
    APP_EXTENSION_PROJECT_MAPPING = {'sonic-wjh': WJH_APP_NAME,
                                     ...
                                     'doai': DOAI,
                                     'doroce': DOROCE}
    APPS_WHERE_SX_SDK_NOT_PRESENT = [P4SamplingConsts.APP_NAME, P4ExamplesConsts.APP_NAME, DOAI, DOROCE]
...
class MarsConstants:
    ...
    TOPO_ARRAY = ("t0-56-po2vlan", "t0", "t1-lag", "t1-28-lag", "ptf32", "t0-64", "t1-64-lag", "t0-56")
    REBOOT_TYPES = {
        "reboot": "reboot",
...
class BugHandlerConst:
    ...
    BUG_HANDLER_SCRIPT = "/auto/sw_tools/Internal/BugHandling/RELEASES/0_9/bin/handle_bug.py"
