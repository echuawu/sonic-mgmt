...
class RunPytest(TermHandlerMixin, StandaloneWrapper):
    ...
    def run_commands(self):
        ...
        if '--allure_server_project_id' in self.raw_options:
            ...
            allure_proj = get_allure_project_id(os.environ['MARS_SETUP_ID'], self.test_scripts, get_dut_name_only=False)
    ...
    def collect_allure_report_data(self):
        ...
        cmd = 'PYTHONPATH=/devts /ngts_venv/bin/python {}/ngts/scripts/allure_reporter.py --action upload --setup_name {}'.format(self.sonic_mgmt_path, os.environ['MARS_SETUP_ID'])
