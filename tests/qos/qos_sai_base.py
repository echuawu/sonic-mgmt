...
class QosSaiBase(QosBase):
    ...
    def __compute_buffer_threshold_for_nvidia_device(self, dut_asic, table, port, pg_q_buffer_profile):
        ...
        port_table_name = "BUFFER_PORT_EGRESS_PROFILE_LIST_TABLE" if table == "BUFFER_QUEUE_TABLE" else "BUFFER_PORT_INGRESS_PROFILE_LIST_TABLE"
        db = "0"
    ...
    def dutConfig(
        ...
        if topo in self.SUPPORTED_T0_TOPOS or (topo in self.SUPPORTED_PTF_TOPOS and isMellanoxDevice(duthost)):
            pytest_assert(
